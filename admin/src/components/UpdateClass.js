...
export default function UpdateClassPage() {
    ...
    const fetchImgs = async () => {
      try {
        const response = await axios.get(
          "https://dance-fit-studio.herokuapp.com/admin/imgs"
        );
  ...
  useEffect(() => {
    const fetchClass = async () => {
      try {
        const response = await axios.get(
          `https://dance-fit-studio.herokuapp.com/admin/classes/${classID}`
        );
    ...
    onSubmit: async (values) => {
      try {
        const response = await axios({
          method: "POST",
          url: "https://dance-fit-studio.herokuapp.com/admin/updateClass",
